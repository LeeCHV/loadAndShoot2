...
/*
InterruptIn arm_move_limSwit_right(PB_8);     //D15
InterruptIn arm_move_limSwit_left(PB_9);      //D14
InterruptIn arm_turn_limSwit_right(PA_5);     //D13
InterruptIn arm_turn_limSwit_left(PA_6);      //D12
InterruptIn arrow_tail_limSwit_right(PA_7);   //D11
InterruptIn arrow_tail_limSwit_left(PB_6);    //D10
*/
